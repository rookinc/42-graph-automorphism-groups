...
These invariants characterize the graph from the viewpoint of elementary
graph theory. The subsequent sections investigate the additional structure
arising from its quotient frames, homogeneous-space realization, and
automorphism group.
