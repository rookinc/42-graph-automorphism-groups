...
This paper is one of two companion studies. The present work determines
the full symmetry of the thirty-vertex graph
\[
X=\KC(L(P)),
\]
obtaining
...
\Aut(X)\cong S_5\times S_3.
\]
The companion paper determines the full symmetry of the distinct
sixty-vertex graph
\[
...
obtaining
\[
\Aut(G60)\cong S_5\times_{C_2}D_8.
\]
The canonical thirty-vertex quotient
\[
G30=G60/\langle a\rangle
\]
appearing in that study is not isomorphic to \(X\): their automorphism
groups have orders \(240\) and \(720\), respectively.
