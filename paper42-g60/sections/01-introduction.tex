...
This paper is one of two companion studies. The present work concerns
the sixty-vertex graph
\[
G60\cong \mathrm{AT4val}[60,6],
\]
and determines
\[
\operatorname{Aut}(G60)\cong S_5\times_{C_2}D_8.
\]
The companion paper concerns the distinct thirty-vertex graph
\[
...
\]
The canonical quotient $G30=G60/\langle a\rangle$ appearing here is not
isomorphic to $X$: their automorphism groups have orders $240$ and $720$,
respectively.
