...
The quotient $G30$ should not be confused merely by vertex count with the
separately studied graph
\[
X=\operatorname{KC}(L(P)).
\]
The present manuscript concerns the native graph $G60$ and the specific
quotient arising from its involution $a$. Any identification or comparison
between thirty-vertex models must be established by an explicit
isomorphism or certificate rather than inferred from notation.
