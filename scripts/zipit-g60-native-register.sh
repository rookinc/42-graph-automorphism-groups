...
PAPER_DIR="$PROJECT_DIR/paper42-g60-native-register"
DIST_DIR="$PROJECT_DIR/dist"
BUILD_DIR="$PROJECT_DIR/build"
STAGE_DIR="$BUILD_DIR/overleaf_g60_native_register_stage"

ZIP_BASENAME="${1:-project42_g60_native_register_overleaf.zip}"
